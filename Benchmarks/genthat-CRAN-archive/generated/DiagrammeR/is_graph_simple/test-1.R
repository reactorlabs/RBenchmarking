...
genthat_extracted_call <- function() {
    . <- structure(list(graph_info = structure(list(graph_id = "wkAYJjR5", graph_name = "graph_wkAYJjR5", graph_time = structure(1628396902.2213, 
        ...
        node_selection = structure(list(node = integer(0)), row.names = integer(0), class = "data.frame"), edge_selection = structure(list(edge = integer(0), 
            ...
            function_used = c("create_graph", "add_cycle", "add_cycle"), time_modified = structure(c(1628396902.2213, 1628396902.37852, 
                1628396902.54093), class = c("POSIXct", "POSIXt")), duration = c(0.151556730270386, 0.107713937759399, 0.192402362823486), 
            nodes = c(0L, 4L, 7L), edges = c(0L, 4L, 7L), d_n = c(0L, 4L, 3L), d_e = c(0L, 4L, 3L)), row.names = c(NA, -3L), 
            class = "data.frame")), class = "dgr_graph")
    DiagrammeR:::is_graph_simple(graph = .)
}
