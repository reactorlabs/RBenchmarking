...
function_to_run <- function() {
    . <- structure(list(graph_info = structure(list(graph_id = "wkAYJjR5", graph_name = "graph_wkAYJjR5", graph_time = structure(1628396591.62411, 
        ...
        "17", "18", "19", "20")), row.names = c(NA, -20L), class = "data.frame"), edges_df = structure(list(id = 1:35, from = c(1L, 
        ...
        node_selection = structure(list(node = integer(0)), row.names = integer(0), class = "data.frame"), edge_selection = structure(list(edge = integer(0), 
            ...
            function_used = c("create_graph", "add_gnm_graph"), time_modified = structure(c(1628396591.62411, 1628396591.77574), 
                class = c("POSIXct", "POSIXt")), duration = c(0.146077394485474, 0.885360240936279), nodes = c(0L, 20L), 
            edges = c(0L, 35L), d_n = c(0L, 20L), d_e = c(0L, 35L)), row.names = c(NA, -2L), class = "data.frame")), class = "dgr_graph")
    DiagrammeR:::count_nodes(graph = .)
}
