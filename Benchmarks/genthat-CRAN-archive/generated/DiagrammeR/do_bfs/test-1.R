...
genthat_extracted_call <- function() {
    . <- structure(list(graph_info = structure(list(graph_id = "wkAYJjR5", graph_name = "graph_wkAYJjR5", graph_time = structure(1628396535.97838, 
        ...
        node_selection = structure(list(node = integer(0)), row.names = integer(0), class = "data.frame"), edge_selection = structure(list(edge = integer(0), 
            ...
            function_used = c("create_graph", "add_balanced_tree", "add_balanced_tree"), time_modified = structure(c(1628396535.97838, 
                1628396536.12877, 1628396536.29584), class = c("POSIXct", "POSIXt")), duration = c(0.144869089126587, 0.110831499099731, 
                0.190930843353271), nodes = c(0L, 7L, 20L), edges = c(0L, 6L, 18L), d_n = c(0L, 7L, 13L), d_e = c(0L, 6L, 
                12L)), row.names = c(NA, -3L), class = "data.frame")), class = "dgr_graph")
    DiagrammeR:::do_bfs(graph = ., node = 1, direction = "in")
}
