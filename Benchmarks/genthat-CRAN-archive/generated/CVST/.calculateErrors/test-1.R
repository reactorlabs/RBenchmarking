...
genthat_extracted_call <- function() {
    train <- structure(list(x = structure(c(28.7394794570769, 29.4390923427618, 8.98933860386378, 26.0892816124419, 20.1610300762843, 
    ...
    test <- NULL
    skipCalculation <- structure(c(TRUE, TRUE, FALSE, FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, FALSE, TRUE, TRUE, TRUE, 
        TRUE, TRUE, FALSE, FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, FALSE, TRUE, TRUE, TRUE), names = c("kernel=rbfdot sigma=0.001 nu=0.05", 
        ...
        "kernel=rbfdot sigma=10 nu=0.3", "kernel=rbfdot sigma=100 nu=0.3", "kernel=rbfdot sigma=1000 nu=0.3"))
    ...
    CVST:::.calculateErrors(traindata = train, testdata = test, N = n, learner = learner, params = params, skipCalculation = skipCalculation)
}
