...
function_to_run <- function() {
    . <- structure(list(graph_info = structure(list(graph_id = "jNUsya78", graph_name = "graph_jNUsya78", graph_time = structure(1628397148.52595, 
        ...
        graph_actions = structure(list(action_index = integer(0), action_name = character(0), expression = character(0)), 
            ...
            "join_node_attrs", "select_edges"), time_modified = structure(c(1628397148.52595, 1628397148.68266, 1628397148.73905, 
            1628397148.79281, 1628397148.79281, 1628397148.869, 1628397148.91148, 1628397149.27002), class = c("POSIXct", 
            "POSIXt")), duration = c(0.150990724563599, 0.0221488475799561, 0.0481245517730713, 0.0696244239807129, 0.0696244239807129, 
            0.036975622177124, 0.0101110935211182, 0.0276236534118652), nodes = c(0L, 2L, 5L, 5L, 5L, 5L, 5L, 5L), edges = c(0L, 
    ...
    DiagrammeR:::trav_in_node(graph = ., conditions = values < 5)
}
