...
genthat_extracted_call <- function() {
    ...
    format.labels <- TRUE
    cnts <- structure(c(8, 0, 8, 5, 4, 0, 5, 7, 2, 8, 4, 5, 1, 1, 1, 8, 1, 2, 7, 2, 8, 0, 3, 3, 1, 3, 4, 0, 9, 9, 9, 1, 0, 
        1, 3, 5, 9, 6, 4, 0, 9, 3, 3, 6, 7, 1, 5, 8, 9, 0, 8, 2, 1, 6, 2, 8, 6, 5, 0, 2, 0, 8, 1, 0, 3, 6, 8, 2, 3, 6, 5, 
        0, 4, 9, 2, 6, 9, 0, 1, 1, 4, 9, 3, 7, 7, 0, 9, 5, 6, 0, 9, 0, 7, 5, 2, 5, 5, 0, 9, 5, 0, 6, 6, 0, 4, 6, 8, 3, 7, 
        8, 6, 3, 9, 7, 0, 1, 8, 7, 0, 9, 7, 9, 5, 3, 8, 7, 5, 7, 0, 4, 0, 7, 7, 0, 4, 5, 2, 0, 3, 5, 2, 9, 4, 7, 1, 2, 0, 
        3, 4, 1, 8, 0, 9, 8, 5, 9, 4, 5, 8, 1, 5, 4, 3, 4, 0, 2, 1, 3, 6, 4, 0, 6, 8, 8, 0, 0, 4, 9, 4, 9, 4, 1, 5, 2, 7, 
        7, 4, 4, 4, 9, 5, 6, 3, 0, 9, 6, 0, 1, 8, 4, 4, 4, 6, 1, 8, 9, 7, 5, 2, 6, 9, 9, 0, 3, 8, 5, 3, 4, 0, 8, 0, 6, 5, 
        3, 9, 8, 6, 1, 8, 5, 7, 0, 2, 7, 8, 5, 6, 4, 5, 1, 8, 4, 7, 9, 2, 8, 6, 7, 1, 7, 7, 7, 3, 0, 6, 0, 6, 2, 3, 9, 6, 
        7, 7, 2, 4, 5, 8, 5, 9, 3, 2, 7, 2, 4, 6, 6, 1, 7, 3, 3, 7, 3, 2, 2, 0, 6, 7, 6, 0, 5, 0, 2, 0, 7, 7, 1, 5, 3, 6, 
        3, 8, 9, 4, 0, 1, 8, 7, 8, 9, 4, 0, 7, 2, 3, 3, 3, 0, 5, 7, 5, 2, 4, 8, 9, 5, 7, 7, 8, 9, 4, 6, 2, 8, 9, 5, 6, 0, 
        2, 5, 5, 7, 2, 6, 5, 4, 8, 1, 3, 7, 5, 1, 6, 1, 2, 7, 0, 1, 4, 5, 1, 5, 8, 0, 4, 8, 4, 2, 0, 8, 1, 3, 6, 2, 4, 4, 
        2, 3, 0, 3, 9, 1, 8, 1, 1, 7, 2, 2, 5, 0, 4, 3, 8, 2, 5, 0, 5, 3, 0, 5, 4, 6, 0, 6, 3, 1, 2, 3, 6, 1, 4, 2, 3, 1, 
        2, 1, 4, 7, 0, 3, 8, 3, 4, 9, 7, 4, 9, 2, 1, 7, 8, 3, 9, 9, 8, 3, 6, 2, 9, 1, 3, 6, 2, 9, 5, 3, 6, 6, 8, 6, 8, 9, 
        5, 7, 3, 1, 9, 2, 0, 2, 2, 5, 6, 4, 1, 6, 6, 2, 2, 3, 3, 7, 2, 4, 8, 2, 4, 8, 3, 5, 7, 1, 9, 9, 5, 1, 5, 0, 9, 0, 
        5, 7, 1, 2, 4, 3, 6, 6, 7, 3, 1), .Dim = c(250L, 2L), .Dimnames = list(NULL, c("counts1", "counts2")))
    ...
    cfa:::mcfa(cfg = cfg, cnts = cnts, sorton = sorton, sort.descending = sort.descending, format.labels = format.labels)
}
