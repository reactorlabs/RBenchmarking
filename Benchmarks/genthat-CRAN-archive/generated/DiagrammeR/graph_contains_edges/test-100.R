...
function_to_run <- function() {
    graph <- structure(list(graph_info = structure(list(graph_id = "jNUsya78", graph_name = "graph_jNUsya78", graph_time = structure(1628397136.55274, 
        ...
        cache = list(), graph_actions = structure(list(action_index = integer(0), action_name = character(0), expression = character(0)), 
            ...
            "join_node_attrs", "select_nodes_by_id"), time_modified = structure(c(1628397136.55274, 1628397136.7092, 1628397136.76474, 
            1628397136.81893, 1628397136.81893, 1628397136.89544, 1628397136.93812, 1628397137.37995), class = c("POSIXct", 
            "POSIXt")), duration = c(0.150737285614014, 0.0165369510650635, 0.0485756397247314, 0.0700578689575195, 0.0700578689575195, 
            0.0371687412261963, 0.0101015567779541, 0.039081335067749), nodes = c(0L, 2L, 5L, 5L, 5L, 5L, 5L, 5L), edges = c(0L, 
    ...
    DiagrammeR:::graph_contains_edges(graph = graph)
}
