...
function_to_run <- function() {
    GVME <- structure(list(`1975` = structure(list(.Data = structure(c(0.72, 0.04, 0.99, 0.59, 0.04, 0.98, 0.38, 0.11, 0.01, 
    ...
    clue:::cl_consensus(x = GVME, method = "GV1", control = list(k = 2, verbose = TRUE))
}
