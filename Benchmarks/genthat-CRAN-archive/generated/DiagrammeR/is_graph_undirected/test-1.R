...
genthat_extracted_call <- function() {
    . <- structure(list(graph_info = structure(list(graph_id = "wkAYJjR5", graph_name = "graph_wkAYJjR5", graph_time = structure(1628396905.81688, 
        ...
        "edge")), row.names = c(NA, -17L), class = "data.frame"), directed = FALSE, last_node = 0, last_edge = 0, node_selection = structure(list(node = integer(0)), 
        ...
        function_used = "create_graph", time_modified = structure(1628396905.81688, class = c("POSIXct", "POSIXt")), duration = 0.151937484741211, 
        nodes = 0L, edges = 0L, d_n = 0L, d_e = 0L), row.names = c(NA, -1L), class = "data.frame")), class = "dgr_graph")
    DiagrammeR:::is_graph_undirected(graph = .)
}
