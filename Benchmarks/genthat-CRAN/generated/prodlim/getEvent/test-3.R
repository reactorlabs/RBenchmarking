...
function_to_run <- function() {
    ehf <- structure(list(event.history = structure(c(1, 2, 3, 4, 5, 6, 7, 1, 0, 1, 1, 1, 1, 0, 1, 3, 2, 1, 2, 2, 3), .Dim = c(7L,
        ...
        "cause2"), cens.type = "rightCensored", cens.code = "0", model = "competing.risks", entry.type = ""), design = structure(c(44.69,
        37.41, 68.54, 38.85, 35.9, 27.02, 41.84), .Dim = c(7L, 1L), .Dimnames = list(c("1", "2", "3", "4", "5", "6", "7"),
        "X4"), .Label = structure(list(), names = character())), prop = structure(list(X1 = structure(c(2L, 3L, 2L, 1L, 1L,
        2L, 3L), .Label = c("c", "a", "b"), class = "factor")), terms = ~X1, row.names = c(NA, 7L), class = "data.frame",
        ...
        X3 + X4, class = "EventHistory.frame")
