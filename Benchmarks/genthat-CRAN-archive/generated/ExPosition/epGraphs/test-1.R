...
genthat_extracted_call <- function() {
    ...
    main <- "authors$ca$data"
    graphs <- TRUE
    DESIGN <- structure(c(1, 1, 1, 1, 1, 1), .Dim = c(6L, 1L), .Dimnames = list(c("Rousseau", "Chateaubriand", "Hugo", "Zola", 
        "Proust", "Giraudoux"), NULL))
    ExPosition:::epGraphs(res = res, DESIGN = DESIGN, main = main, graphs = graphs)
}
