...
genthat_extracted_call <- function() {
    df <- structure(list(Sepal.Length = c(5.1, 4.9, 4.7, 4.6, 5, 5.4, 4.6, 5, 4.4, 4.9, 5.4, 4.8, 4.8, 4.3, 5.8, 5.7, 5.4, 
        ...
        .Label = c("setosa", "versicolor", "virginica"), class = "factor")), class = "data.frame", row.names = c(NA, -150L))
    BBmisc:::seq_row(x = df)
}
