...
function_to_run <- function() {
    ...
    out <- list(Balance = structure(list(Type = c("Distance", "Contin.", "Contin.", "Binary", "Binary", "Binary", "Binary", 
        ...
        0.142191142191142, 0.655011655011655, 0.512820512820513, 0.596736596736597, 5619.23650638695, 2466.48444312354), 
        SD.0.Un = c(0.229520554706501, 10.7866530174644, 2.85523844087595, NA, NA, NA, NA, NA, 6788.75079645538, 3291.99618331065), 
        M.1.Un = c(0.577435546655728, 25.8162162162162, 10.3459459459459, 0.843243243243243, 0.0594594594594595, 0.0972972972972973, 
            0.189189189189189, 0.708108108108108, 2095.57368864865, 1532.05531378378), SD.1.Un = c(0.220285299004571, 7.15501927478617, 
            2.01065025640563, NA, NA, NA, NA, NA, 4886.62035315108, 3219.2508699216), Diff.Un = c(1.79408604967622, -0.309445261997982, 
            0.0549646613888354, 0.64044604044604, -0.0827316827316827, -0.557714357714358, -0.323631323631324, 0.111371511371511, 
            -0.721083809071869, -0.290262911185457), M.Threshold.Un = c(NA, NA, NA, NA, NA, NA, NA, NA, NA, NA), V.Ratio.Un = c(0.921144705541391, 
            0.439995463435061, 0.495893371429209, NA, NA, NA, NA, NA, 0.518128480856177, 0.95629304538895), V.Threshold.Un = c(NA, 
            NA, NA, NA, NA, NA, NA, NA, NA, NA), KS.Un = c(NA, NA, NA, NA, NA, NA, NA, NA, NA, NA), KS.Threshold.Un = c(NA, 
            NA, NA, NA, NA, NA, NA, NA, NA, NA), M.0.Adj = c(0.362891389001665, 25.3027027027027, 10.6054054054054, 0.47027027027027, 
        ...
        thresholds = structure(c(0.1, 2), names = c("m", "v")), disp = structure(c(FALSE, FALSE, TRUE, FALSE), names = c("means", 
            "sds", "v.ratio", "ks"))), Balanced.Means = NULL, Max.Imbalance.Means = NULL, Balanced.Variances = NULL, Max.Imbalance.Variances = NULL, 
        Balanced.KS = NULL, Max.Imbalance.KS = NULL, Observations = NULL, call = NULL)
    cobalt:::baltal(threshold = out[["Balance"]][[s[["Threshold"]]]])
}
