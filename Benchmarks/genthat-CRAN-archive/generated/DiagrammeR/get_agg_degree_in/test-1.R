...
genthat_extracted_call <- function() {
    . <- structure(list(graph_info = structure(list(graph_id = "wkAYJjR5", graph_name = "graph_wkAYJjR5", graph_time = structure(1628396583.73825, 
        ...
        node_selection = structure(list(node = integer(0)), row.names = integer(0), class = "data.frame"), edge_selection = structure(list(edge = integer(0), 
            ...
            2L, 3L, 3L), function_used = c("create_graph", "add_gnm_graph", "set_node_attrs", ""), time_modified = structure(c(1628396583.73825, 
            1628396583.8891, 1628396584.78305, 1628396584.78305), class = c("POSIXct", "POSIXt")), duration = c(0.145305395126343, 
            0.888335466384888, 0.0229358673095703, 0.0229358673095703), nodes = c(0L, 20L, 20L, 20L), edges = c(0L, 35L, 
            35L, 35L), d_n = c(0L, 20L, 0L, 0L), d_e = c(0L, 35L, 0L, 0L)), row.names = c(NA, -4L), class = "data.frame")), 
        class = "dgr_graph")
    DiagrammeR:::get_agg_degree_in(graph = ., agg = "median")
}
