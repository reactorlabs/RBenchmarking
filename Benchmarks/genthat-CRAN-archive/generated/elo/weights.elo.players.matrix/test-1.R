...
function_to_run <- function() {
    t2 <- structure(c("Athletic Armadillos", "Cunning Cats", "Elegant Emus", "Gallivanting Gorillas", "Athletic Armadillos", 
        ...
        "Blundering Baboons", "Defense-less Dogs", "Blundering Baboons", "Cunning Cats", "Defense-less Dogs", "Athletic Armadillos", 
        "Blundering Baboons", "Cunning Cats", "Defense-less Dogs", "Blundering Baboons", "Defense-less Dogs", "Fabulous Frogs", 
        "Helpless Hyenas", "Cunning Cats", "Defense-less Dogs", "Helpless Hyenas", "Cunning Cats", "Defense-less Dogs", "Gallivanting Gorillas", 
        "Helpless Hyenas", "Elegant Emus", "Fabulous Frogs", "Helpless Hyenas", "Elegant Emus", "Fabulous Frogs", "Helpless Hyenas", 
        "Elegant Emus", "Fabulous Frogs", "Gallivanting Gorillas", "Helpless Hyenas", "Elegant Emus", "Fabulous Frogs", "Gallivanting Gorillas", 
        "Helpless Hyenas"), .Dim = c(51L, 1L), class = c("elo.players.matrix", "matrix"), weights = 1)
    elo:::weights.elo.players.matrix(object = t2)
}
