...
function_to_run <- function() {
    hr <- structure(c(7.01683334615683, 6.62193815242765, 1.18584085113217, 2.60362780309618, 8.41890206264328, 2.93390938057572,
    ...
    prodlim:::stopTime(object = hr, stop.time = 5)
}
