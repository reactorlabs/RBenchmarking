...
function_to_run <- function() {
    . <- structure(list(graph_info = structure(list(graph_id = "wkAYJjR5", graph_name = "graph_wkAYJjR5", graph_time = structure(1628396877.87736, 
        ...
        NA_character_), label = c("1", "2", "3", "4")), row.names = c(NA, -4L), class = "data.frame"), edges_df = structure(list(id = 1:5, 
        from = c(1L, 2L, 3L, 1L, 3L), to = c(2L, 3L, 4L, 2L, 4L), rel = c(NA_character_, NA_character_, NA_character_, NA_character_, 
            NA_character_)), row.names = c(NA, -5L), class = "data.frame"), global_attrs = structure(list(attr = c("layout", 
        ...
        "edge", "edge")), row.names = c(NA, -17L), class = "data.frame"), directed = TRUE, last_node = 4, last_edge = 5L, 
        node_selection = structure(list(node = integer(0)), row.names = integer(0), class = "data.frame"), edge_selection = structure(list(edge = integer(0), 
            ...
            function_used = c("create_graph", "add_path", "add_edge", "add_edge"), time_modified = structure(c(1628396877.87736, 
                1628396878.03422, 1628396878.14747, 1628396878.21468), class = c("POSIXct", "POSIXt")), duration = c(0.151180505752563, 
                0.107655763626099, 0.00560879707336426, 0.00445699691772461), nodes = c(0L, 4L, 4L, 4L), edges = c(0L, 3L, 
                4L, 5L), d_n = c(0L, 4L, 0L, 0L), d_e = c(0L, 3L, 1L, 1L)), row.names = c(NA, -4L), class = "data.frame")), 
        class = "dgr_graph")
    DiagrammeR:::is_edge_multiple(graph = ., edge = 2)
}
