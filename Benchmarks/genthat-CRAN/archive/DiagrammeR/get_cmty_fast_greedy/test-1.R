...
function_to_run <- function() {
    . <- structure(list(graph_info = structure(list(graph_id = "wkAYJjR5", graph_name = "graph_wkAYJjR5", graph_time = structure(1628396637.89031, 
        ...
        directed = TRUE, last_node = 7, last_edge = 6, node_selection = structure(list(node = integer(0)), row.names = integer(0), 
            ...
            function_used = c("create_graph", "add_balanced_tree"), time_modified = structure(c(1628396637.89031, 1628396638.04109), 
                class = c("POSIXct", "POSIXt")), duration = c(0.145256519317627, 0.110683679580688), nodes = c(0L, 7L), edges = c(0L, 
                6L), d_n = c(0L, 7L), d_e = c(0L, 6L)), row.names = c(NA, -2L), class = "data.frame")), class = "dgr_graph")
    DiagrammeR:::get_cmty_fast_greedy(graph = .)
}
