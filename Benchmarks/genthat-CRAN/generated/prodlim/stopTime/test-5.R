...
function_to_run <- function() {
    s <- structure(c(8.08489580759416, 14.2340952093652, 0.646046154253689, 2.33291587630756, 8.41890206264328, 1.31159919645468,
    ...
    prodlim:::stopTime(object = s, stop.time = 5)
}
