...
function_to_run <- function() {
    ybox.position <- structure(c(84.4171428571429, 0, 0), names = c("box1", "box2", "box3"))
    xbox.position <- structure(c(37.4205714285714, 0, 74.8411428571429), names = c("box1", "box2", "box3"))
