...
function_to_run <- function() {
    . <- structure(list(graph_info = structure(list(graph_id = "wkAYJjR5", graph_name = "graph_wkAYJjR5", graph_time = structure(1628396634.07373, 
        ...
        node_selection = structure(list(node = integer(0)), row.names = integer(0), class = "data.frame"), edge_selection = structure(list(edge = integer(0), 
            ...
            function_used = c("create_graph", "add_gnm_graph"), time_modified = structure(c(1628396634.07373, 1628396634.22396), 
                class = c("POSIXct", "POSIXt")), duration = c(0.144707918167114, 0.882456064224243), nodes = c(0L, 10L), 
            edges = c(0L, 15L), d_n = c(0L, 10L), d_e = c(0L, 15L)), row.names = c(NA, -2L), class = "data.frame")), class = "dgr_graph")
    DiagrammeR:::get_cmty_edge_btwns(graph = .)
}
