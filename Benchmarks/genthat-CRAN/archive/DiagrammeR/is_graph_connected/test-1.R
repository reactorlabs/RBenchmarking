...
function_to_run <- function() {
    . <- structure(list(graph_info = structure(list(graph_id = "wkAYJjR5", graph_name = "graph_wkAYJjR5", graph_time = structure(1628396864.63108, 
        ...
        -7L), class = "data.frame"), edges_df = structure(list(id = c(1, 2, 3, 4, 5, 6, 7), from = 1:7, to = c(2L, 3L, 4L, 
        1L, 6L, 7L, 5L), rel = c(NA_character_, NA_character_, NA_character_, NA_character_, NA_character_, NA_character_, 
        ...
        "edge", "edge")), row.names = c(NA, -17L), class = "data.frame"), directed = TRUE, last_node = 7, last_edge = 7, 
        node_selection = structure(list(node = integer(0)), row.names = integer(0), class = "data.frame"), edge_selection = structure(list(edge = integer(0), 
            ...
            function_used = c("create_graph", "add_cycle", "add_cycle"), time_modified = structure(c(1628396864.63108, 1628396864.7886, 
                1628396864.95186), class = c("POSIXct", "POSIXt")), duration = c(0.151750087738037, 0.108366012573242, 0.192527055740356), 
            nodes = c(0L, 4L, 7L), edges = c(0L, 4L, 7L), d_n = c(0L, 4L, 3L), d_e = c(0L, 4L, 3L)), row.names = c(NA, -3L), 
            class = "data.frame")), class = "dgr_graph")
    DiagrammeR:::is_graph_connected(graph = .)
}
