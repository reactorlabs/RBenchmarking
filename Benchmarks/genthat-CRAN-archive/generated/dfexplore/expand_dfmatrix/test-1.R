...
genthat_extracted_call <- function() {
    dataframe_with_matrix <- structure(list(subject = 1:100, initial = c("ph", "pf", "kf", "og", "mk", "ml", "ni", "ji", 
        ...
        "pe", "mk", "qf", "me", "ki", "lf", "li", "ng", "hi", "ni", "ne", "jc", "ke", "mi", "nk", "rh", "nh", "mf", "oh", 
        "je", "kg", "of", "ne", "ke", "hi", "jg", "kg", "lg", "jg", "ne", "gj", "lh", "mi", "ei", "mk", "jj", "lf", "mf", 
        "ni", "mi", "kk", "ii", "ie", "kf", "nf", "di", "je", "pe", "pd", "nd", "kh", "me", "ni", "mi"), birth = structure(c(10957.031, 
    ...
    dfexplore:::expand_dfmatrix(dataframe = dataframe_with_matrix)
}
