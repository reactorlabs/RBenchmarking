...
genthat_extracted_call <- function() {
    y <- structure(list(structure(list(structure(1L, label = 5L, members = 1L, height = 0, leaf = TRUE), structure(2L, label = 4L, 
        members = 1L, height = 0, leaf = TRUE)), members = 2L, midpoint = 0.5, height = 1), structure(list(structure(5L, 
    ...
    x <- structure(list(structure(list(structure(1L, label = 1L, members = 1L, height = 0, leaf = TRUE), structure(2L, label = 2L, 
        members = 1L, height = 0, leaf = TRUE)), members = 2L, midpoint = 0.5, height = 1), structure(list(structure(5L, 
        ...
        members = 3L, midpoint = 0.75, height = 2)), members = 5L, midpoint = 1.625, height = 4, class = "dendrogram")
    dendlist <- dendextend::dendlist
    dendextend:::dist.dendlist(dend = dendlist(x1 = x, x2 = x, y1 = y))
}
