...
function_to_run <- function() {
    SurvHist <- structure(c(3.0078595999024, 4.57623464737715, 9.16821902062108, 0.723817486990457, 7.48737362740717, 1.33164902358783,
    ...
    prodlim:::summary.Hist(object = SurvHist)
}
