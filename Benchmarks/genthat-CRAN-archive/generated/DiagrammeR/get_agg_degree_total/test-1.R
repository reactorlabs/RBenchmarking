...
genthat_extracted_call <- function() {
    . <- structure(list(graph_info = structure(list(graph_id = "wkAYJjR5", graph_name = "graph_wkAYJjR5", graph_time = structure(1628396591.62411, 
        ...
        node_selection = structure(list(node = integer(0)), row.names = integer(0), class = "data.frame"), edge_selection = structure(list(edge = integer(0), 
            ...
            2L, 3L, 3L), function_used = c("create_graph", "add_gnm_graph", "set_node_attrs", ""), time_modified = structure(c(1628396591.62411, 
            1628396591.77574, 1628396592.66674, 1628396592.66674), class = c("POSIXct", "POSIXt")), duration = c(0.146077394485474, 
            0.885360240936279, 0.0224711894989014, 0.0224711894989014), nodes = c(0L, 20L, 20L, 20L), edges = c(0L, 35L, 
            35L, 35L), d_n = c(0L, 20L, 0L, 0L), d_e = c(0L, 35L, 0L, 0L)), row.names = c(NA, -4L), class = "data.frame")), 
        class = "dgr_graph")
    DiagrammeR:::get_agg_degree_total(graph = ., agg = "mean", conditions = value < 5)
}
