...
function_to_run <- function() {
    ...
    grouping <- c(0, 0, 0, 0, 0, 0, 0.94, 0.94, 0.94, 1.88, 1.88, 1.88, 3.75, 3.75, 3.75, 7.5, 7.5, 7.5, 15, 15, 15, 30, 
        30, 30)
    drc:::neill.default(object = object, grouping = grouping, anovaDisplay = TRUE)
}
