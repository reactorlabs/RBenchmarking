...
genthat_extracted_call <- function() {
    . <- structure(list(graph_info = structure(list(graph_id = "wkAYJjR5", graph_name = "graph_wkAYJjR5", graph_time = structure(1628396874.53041, 
        ...
        from = c(1L, 2L, 3L, 1L, 3L), to = c(2L, 3L, 4L, 1L, 3L), rel = c(NA_character_, NA_character_, NA_character_, NA_character_, 
        ...
        node_selection = structure(list(node = integer(0)), row.names = integer(0), class = "data.frame"), edge_selection = structure(list(edge = integer(0), 
            ...
            function_used = c("create_graph", "add_path", "add_edge", "add_edge"), time_modified = structure(c(1628396874.53041, 
                1628396874.68755, 1628396874.8013, 1628396874.86866), class = c("POSIXct", "POSIXt")), duration = c(0.151377201080322, 
                0.108110427856445, 0.00562429428100586, 0.00447821617126465), nodes = c(0L, 4L, 4L, 4L), edges = c(0L, 3L, 
                4L, 5L), d_n = c(0L, 4L, 0L, 0L), d_e = c(0L, 3L, 1L, 1L)), row.names = c(NA, -4L), class = "data.frame")), 
        class = "dgr_graph")
    DiagrammeR:::is_edge_loop(graph = ., edge = 2)
}
