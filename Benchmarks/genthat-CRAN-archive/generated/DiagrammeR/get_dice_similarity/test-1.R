...
function_to_run <- function() {
    . <- structure(list(graph_info = structure(list(graph_id = "wkAYJjR5", graph_name = "graph_wkAYJjR5", graph_time = structure(1628396684.37102, 
        ...
        node_selection = structure(list(node = integer(0)), row.names = integer(0), class = "data.frame"), edge_selection = structure(list(edge = integer(0), 
            ...
            function_used = c("create_graph", "add_gnm_graph"), time_modified = structure(c(1628396684.37102, 1628396684.52816), 
                class = c("POSIXct", "POSIXt")), duration = c(0.151384115219116, 0.911570310592651), nodes = c(0L, 10L), 
            edges = c(0L, 15L), d_n = c(0L, 10L), d_e = c(0L, 15L)), row.names = c(NA, -2L), class = "data.frame")), class = "dgr_graph")
    DiagrammeR:::get_dice_similarity(graph = ., nodes = 5:7)
}
