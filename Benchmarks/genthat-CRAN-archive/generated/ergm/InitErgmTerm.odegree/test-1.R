...
function_to_run <- function() {
    ergm:::InitErgmTerm.odegree(nw = structure(list(mel = list(list(inl = 1, outl = 3, atl = list(na = FALSE)), list(inl = 2, 
        ...
        multiple = FALSE, bipartite = FALSE), val = list(list(na = FALSE, vertex.names = "V1"), list(na = FALSE, vertex.names = "V2"), 
        list(na = FALSE, vertex.names = "V3"), list(na = FALSE, vertex.names = "V4")), iel = list(1, 2, c(3, 4), 5), oel = list(c(2, 
        3, 5), numeric(0), 1, 4)), class = "network"), arglist = list(3), initialfit = TRUE, role = "static")
}
