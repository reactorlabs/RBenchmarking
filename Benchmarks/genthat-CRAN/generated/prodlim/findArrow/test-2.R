...
function_to_run <- function() {
    ybox.position <- structure(c(45.2942857142857, 90.5885714285714, 45.2942857142857, 0), names = c("box1", "box2", "box3",
        "box4"))
    xbox.position <- structure(c(0, 75.1291428571429, 75.1291428571429, 75.1291428571429), names = c("box1", "box2", "box3",
        "box4"))
    to.state <- structure(3L, .Label = c("1", "2", "3", "4"), class = "factor")
    from.state <- structure(1L, .Label = c("1", "2", "3", "4"), class = "factor")
    box.width <- c(24.8708571428571, 24.8708571428571, 24.8708571428571, 24.8708571428571)
