...
function_to_run <- function() {
    knnImp <- structure(list(importance = structure(list(setosa = c(90.7004830917874, 54.5893719806763, 100, 100), versicolor = c(59.2995169082125, 
