...
genthat_extracted_call <- function() {
    graph <- structure(list(graph_info = structure(list(graph_id = "wkAYJjR5", graph_name = "graph_wkAYJjR5", graph_time = structure(1628396583.73825, 
        ...
        class = "dgr_graph")
    DiagrammeR:::get_degree_in(graph = graph)
}
