...
function_to_run <- function() {
    . <- structure(list(graph_info = structure(list(graph_id = "wkAYJjR5", graph_name = "graph_wkAYJjR5", graph_time = structure(1628396587.68582, 
        ...
        class = "dgr_graph")
    DiagrammeR:::get_agg_degree_out(graph = ., agg = "median")
}
