...
function_to_run <- function() {
    graph <- structure(list(graph_info = structure(list(graph_id = "wkAYJjR5", graph_name = "graph_wkAYJjR5", graph_time = structure(1628397014.44087, 
        ...
        -7L), class = "data.frame"), edges_df = structure(list(id = 1:6, from = c(1L, 1L, 2L, 2L, 3L, 3L), to = 2:7, rel = c(NA_character_, 
        NA_character_, NA_character_, NA_character_, NA_character_, NA_character_)), row.names = c(NA, -6L), class = "data.frame"), 
        ...
        directed = TRUE, last_node = 7, last_edge = 6, node_selection = structure(list(node = integer(0)), row.names = integer(0), 
            ...
            function_used = c("create_graph", "add_balanced_tree"), time_modified = structure(c(1628397014.44087, 1628397014.59786), 
                class = c("POSIXct", "POSIXt")), duration = c(0.151230573654175, 0.109059572219849), nodes = c(0L, 7L), edges = c(0L, 
                6L), d_n = c(0L, 7L), d_e = c(0L, 6L)), row.names = c(NA, -2L), class = "data.frame")), class = "dgr_graph")
    DiagrammeR:::graph_object_valid(graph = graph)
}
