...
genthat_extracted_call <- function() {
    ...
    mf <- structure(list(income = c(12351L, 25879L, 9271L, 8865L, 8403L, 11030L, 8258L, 14163L, 11377L, 11023L, 5902L, 7059L, 
        ...
        14032L, 8845L, 5562L, 4224L, 4753L, 6462L, 3617L)), terms = ~income, row.names = c("gov.administrators", "general.managers", 
        ...
        "bookbinders"), class = "data.frame")
    car:::symbox.default(x = as.vector(mf[[1]]), ylab = ylab)
}
