...
function_to_run <- function() {
    . <- structure(list(graph_info = structure(list(graph_id = "wkAYJjR5", graph_name = "graph_wkAYJjR5", graph_time = structure(1628396611.64688, 
        ...
        from = c(1L, 2L, 2L, 2L, 3L, 3L, 3L, 4L, 4L, 4L, 4L, 6L, 7L, 8L, 8L), to = c(8L, 5L, 7L, 9L, 6L, 7L, 8L, 1L, 2L, 
            10L, 8L, 2L, 10L, 1L, 5L), rel = c(NA_character_, NA_character_, NA_character_, NA_character_, NA_character_, 
            NA_character_, NA_character_, NA_character_, NA_character_, NA_character_, NA_character_, NA_character_, NA_character_, 
            NA_character_, NA_character_)), row.names = c(NA, -15L), class = "data.frame"), global_attrs = structure(list(attr = c("layout", 
        ...
        "edge", "edge")), row.names = c(NA, -17L), class = "data.frame"), directed = TRUE, last_node = 10, last_edge = 15, 
        node_selection = structure(list(node = integer(0)), row.names = integer(0), class = "data.frame"), edge_selection = structure(list(edge = integer(0), 
            ...
            function_used = c("create_graph", "add_gnm_graph"), time_modified = structure(c(1628396611.64688, 1628396611.79808), 
                class = c("POSIXct", "POSIXt")), duration = c(0.145648717880249, 0.888014078140259), nodes = c(0L, 10L), 
            edges = c(0L, 15L), d_n = c(0L, 10L), d_e = c(0L, 15L)), row.names = c(NA, -2L), class = "data.frame")), class = "dgr_graph")
    DiagrammeR:::get_authority_centrality(graph = .)
}
