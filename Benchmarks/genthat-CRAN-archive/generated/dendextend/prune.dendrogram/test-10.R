...
function_to_run <- function() {
    ...
    dend1 <- structure(list(structure(list(structure(list(structure(15L, label = "15", members = 1L, height = 0, leaf = TRUE), 
        structure(16L, label = "16", members = 1L, height = 0, leaf = TRUE)), members = 2L, midpoint = 0.5, height = 0.547722557505166), 
        structure(list(structure(list(structure(6L, label = "6", members = 1L, height = 0, leaf = TRUE), structure(19L, label = "19", 
            members = 1L, height = 0, leaf = TRUE)), members = 2L, midpoint = 0.5, height = 0.33166247903554), structure(list(structure(17L, 
            members = 1L, height = 0, label = "17", leaf = TRUE), structure(list(structure(11L, label = "11", members = 1L, 
            height = 0, leaf = TRUE), structure(20L, label = "20", members = 1L, height = 0, leaf = TRUE)), members = 2L, 
            midpoint = 0.5, height = 0.331662479035541)), members = 3L, midpoint = 0.75, height = 0.387298334620742)), members = 5L, 
            midpoint = 1.625, height = 0.632455532033676)), members = 7L, midpoint = 2.0625, height = 0.854400374531754), 
    ...
    dendextend:::prune.dendrogram(dend = dend1, leaves = labels_dend1[ss_labels_to_prune_1])
}
