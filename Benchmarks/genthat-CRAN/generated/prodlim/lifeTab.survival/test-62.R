...
function_to_run <- function() {
    ...
    stats <- list(c("surv", "1"), c("se.surv", "0"), c("lower", "0"), c("upper", "1"))
    showTime <- TRUE
    percent <- TRUE
    ...
    intervals <- FALSE
    prodlim:::lifeTab.survival(object = object, times = times, newdata = X, stats = stats, intervals = intervals, percent = percent,
        showTime = showTime)
}
