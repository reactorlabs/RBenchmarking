...
genthat_extracted_call <- function() {
    ...
    results <- structure(list(fi = structure(c(0.239767473136446, 0.189518958383072, 0.10330548680492, -0.0918118833493732, 
        -0.224269920650726, 0.0475390901828867, 0.0740878384135639, 0.107109285203541, -0.029711901424966, 0.00166787208848225, 
        0.0631132948209885, -0.196253875482298), .Dim = c(6L, 2L), .Dimnames = list(c("Rousseau", "Chateaubriand", "Hugo", 
        "Zola", "Proust", "Giraudoux"), NULL)), di = structure(c(0.0629774489750308, 0.0473898345634181, 0.0115548206902885, 
        0.00843220372146245, 0.054280285291844, 0.0407755487372378), .Dim = c(6L, 1L), .Dimnames = list(c("Rousseau", "Chateaubriand", 
        "Hugo", "Zola", "Proust", "Giraudoux"), NULL)), ci = structure(c(0.0610735719816765, 0.280728204827955, 0.151053409928561, 
    ...
    ExPosition:::computeConstraints(results = results, x_axis = x_axis, y_axis = y_axis)
}
