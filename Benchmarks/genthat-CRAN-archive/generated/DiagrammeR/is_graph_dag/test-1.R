...
function_to_run <- function() {
    . <- structure(list(graph_info = structure(list(graph_id = "wkAYJjR5", graph_name = "graph_wkAYJjR5", graph_time = structure(1628396892.49054, 
        ...
        directed = TRUE, last_node = 15, last_edge = 14, node_selection = structure(list(node = integer(0)), row.names = integer(0), 
            ...
            function_used = c("create_graph", "add_balanced_tree"), time_modified = structure(c(1628396892.49054, 1628396892.6473), 
                class = c("POSIXct", "POSIXt")), duration = c(0.151046991348267, 0.109011888504028), nodes = c(0L, 15L), 
            edges = c(0L, 14L), d_n = c(0L, 15L), d_e = c(0L, 14L)), row.names = c(NA, -2L), class = "data.frame")), class = "dgr_graph")
    DiagrammeR:::is_graph_dag(graph = .)
}
