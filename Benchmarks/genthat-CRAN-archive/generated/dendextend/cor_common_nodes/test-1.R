...
genthat_extracted_call <- function() {
    ...
    dend1 <- structure(list(structure(list(structure(7L, members = 1L, height = 0, label = "123", leaf = TRUE), structure(list(structure(4L, 
    ...
    dendextend:::cor_common_nodes(dend1 = dend1, dend2 = dend2)
}
