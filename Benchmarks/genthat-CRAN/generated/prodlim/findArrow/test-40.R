...
function_to_run <- function() {
    ybox.position <- structure(c(0, 90.5885714285714, 0), names = c("box1", "box2", "box3"))
    xbox.position <- structure(c(0, 38.9917142857143, 77.9834285714286), names = c("box1", "box2", "box3"))
