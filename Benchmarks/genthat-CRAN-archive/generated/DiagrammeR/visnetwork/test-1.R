...
genthat_extracted_call <- function() {
    graph <- structure(list(graph_info = structure(list(graph_id = "rtb3Lq99", graph_name = "graph_rtb3Lq99", graph_time = structure(1628396988.67895, 
        ...
        "10", "11", "12", "13", "14", "15")), row.names = c(NA, -15L), class = "data.frame"), edges_df = structure(list(id = 1:14, 
        ...
        directed = TRUE, last_node = 15, last_edge = 14, node_selection = structure(list(node = integer(0)), row.names = integer(0), 
            ...
            function_used = c("create_graph", "add_balanced_tree"), time_modified = structure(c(1628396988.67895, 1628396988.6914), 
                class = c("POSIXct", "POSIXt")), duration = c(0.0074005126953125, 0.0292046070098877), nodes = c(0L, 15L), 
            edges = c(0L, 14L), d_n = c(0L, 15L), d_e = c(0L, 14L)), row.names = c(NA, -2L), class = "data.frame")), class = "dgr_graph")
    DiagrammeR:::visnetwork(graph = graph)
}
