...
genthat_extracted_call <- function() {
    dend2 <- structure(list(structure(list(structure(9L, members = 1L, height = 0, label = "25", leaf = TRUE), structure(list(structure(1L, 
        ...
        structure(list(structure(7L, members = 1L, height = 0, label = "123", leaf = TRUE), structure(list(structure(5L, 
            ...
            edgePar = list(lty = 3))), members = 6L, midpoint = 1.5625, height = 1.16189500386223, edgePar = list(lty = 3))), 
            members = 7L, midpoint = 1.28125, height = 1.58113883008419, edgePar = list(lty = 3))), members = 10L, midpoint = 2.515625, 
        height = 2.15638586528478, class = "dendrogram")
    dendextend:::has_edgePar(dend = dend2, component = "lwd")
}
