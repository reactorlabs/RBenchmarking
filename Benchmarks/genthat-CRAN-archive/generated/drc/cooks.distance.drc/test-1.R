...
function_to_run <- function() {
    ...
    ryegrass.LL.4 <- structure(list(varParm = NULL, fit = list(par = c(2.98221907127499, 0.481413188446089, 7.79295829369992, 
        3.05795496654811), value = 5.40021462843058, counts = structure(c(35L, 9L), names = c("function", "gradient")), convergence = TRUE, 
    ...
    drc:::cooks.distance.drc(model = ryegrass.LL.4)
}
