...
function_to_run <- function() {
    ybox.position <- structure(c(90.5885714285714, 0, 90.5885714285714, 0), names = c("box1", "box2", "box3", "box4"))
    xbox.position <- structure(c(0, 0, 77.9834285714286, 77.9834285714286), names = c("box1", "box2", "box3", "box4"))
    to.state <- structure(1L, .Label = c("1", "2", "3", "4"), class = "factor")
    from.state <- structure(2L, .Label = c("1", "2", "3", "4"), class = "factor")
