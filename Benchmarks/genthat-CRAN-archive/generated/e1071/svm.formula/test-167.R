...
function_to_run <- function() {
    wts <- structure(c(2, 1), class = "table", .Dim = 2L, .Dimnames = list(c("setosa", "versicolor")))
    i2 <- structure(list(Sepal.Length = c(5.1, 4.9, 4.7, 4.6, 5, 5.4, 4.6, 5, 4.4, 4.9, 5.4, 4.8, 4.8, 4.3, 5.8, 5.7, 5.4, 
        ...
        2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 
        2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L), 
        .Label = c("setosa", "versicolor"), class = "factor")), row.names = c(NA, -150L), class = "data.frame")
    e1071:::svm.formula(formula = Species ~ ., data = i2, class.weights = wts)
}
