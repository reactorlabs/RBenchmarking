...
function_to_run <- function() {
    source_data_frame <- structure(list(subject = 1:100, initial = c("je", "lf", "ik", "lg", "sf", "mi", "jl", "of", "ie", 
        "nh", "pe", "pm", "jg", "ih", "lh", "ng", "ig", "ok", "mi", "jh", "ic", "le", "lg", "og", "if", "pg", "le", "og", 
        "pk", "lf", "lf", "ld", "jh", "kh", "hd", "kk", "lf", "ng", "ji", "me", "ml", "kg", "he", "oj", "if", "lc", "mg", 
        "ig", "oi", "jf", "ig", "pf", "pg", "ng", "kh", "jh", "ni", "lf", "qi", "ie", "je", "oj", "ki", "ng", "jf", "md", 
        "mh", "ql", "kf", "nf", "ik", "li", "ii", "kh", "lk", "kj", "ge", "ni", "ie", "ig", "ki", "le", "rj", "jh", "ja", 
        "md", "jd", "mm", "lf", "ih", "kh", "jg", "jh", "nf", "kh", "lg", "je", "kk", "jh", "ph"), birth = structure(c(10957.031, 
    ...
    dfexplore:::search_matrix_position(dataframe = source_data_frame)
}
